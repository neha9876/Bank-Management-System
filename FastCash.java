    ...
    public void actionPerformed(ActionEvent ae){
            ...
            if(ae.getSource()==b1){
                    ...
                    if(rs.next()){
                        ...
                        balance-=100;
                        String q1= "update bank set withdraw="+100+",balance="+balance+" where pin="+pin;
                    ...
                    if(rs.next()){
                        ...
                        balance-=500;
                        String q1= "update bank set withdraw="+500+",balance="+balance+" where pin="+pin;
                    ...
                    if(rs.next()){
                        ...
                        balance-=1000;
                        String q1= "update bank set withdraw="+1000+",balance="+balance+" where pin="+pin;
                    ...
                    if(rs.next()){
                        ...
                        balance-=2000;
                        String q1= "update bank set withdraw="+2000+",balance="+balance+" where pin="+pin;
                    ...
                    if(rs.next()){
                        ...
                        balance-=5000;
                        String q1= "update bank set withdraw="+5000+",balance="+balance+" where pin="+pin;
                    ...
                    if(rs.next()){
                        ...
                        balance-=10000;
                        String q1= "update bank set withdraw="+10000+",balance="+balance+" where pin="+pin;
